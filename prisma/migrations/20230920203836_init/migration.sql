...
INSERT INTO "new_Reservation" ("arrivalDate", "createdAt", "customerId", "departureDate", "id", "roomId", "updatedAt") SELECT "arrivalDate", "createdAt", "customerId", "departureDate", "id", "roomId", "updatedAt" FROM "Reservation";
